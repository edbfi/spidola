...
android {
    namespace = "dev.spidola.tv.feature.browse"
    compileSdk =
    ...
    testOptions {
        // The view-model logs failures through android.util.Log; return stub defaults so the
        // JVM unit tests exercise the real error path instead of the "not mocked" exception.
